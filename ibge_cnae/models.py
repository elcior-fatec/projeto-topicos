...
class IbgeCNAE(models.Model):
    ...
    secao_id = models.CharField(
        max_length=2,
        verbose_name='id da seção'
    )
    ...
    divisao_id = models.CharField(
        max_length=5,
        verbose_name='id da divisão'
    )
    ...
    classe_id = models.CharField(
        max_length=5,
        verbose_name='id da classe'
    )

    classe_descricao = models.CharField(
        max_length=150,
        verbose_name='nome da classe'
    )

    classe_observacoes = models.TextField(
        verbose_name='descrição da classe'
    )
    ...
    def __str__(self):
        return 'pesquisa nº {0}'.format(self.pk)
